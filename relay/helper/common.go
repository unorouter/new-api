...
func StringData(c *gin.Context, str string) error {
	...
	if c.Request != nil && c.Request.Context().Err() != nil {
		return fmt.Errorf(i18n.Translate("relay.request_context_done_fc25"), c.Request.Context().Err())
	}
...
func PingData(c *gin.Context) error {
	if c == nil || c.Writer == nil {
		return errors.New(i18n.Translate("relay.context_or_writer_is_nil_aa13"))
	}

	if c.Request != nil && c.Request.Context().Err() != nil {
		return fmt.Errorf(i18n.Translate("relay.request_context_done_856c"), c.Request.Context().Err())
	}
...
func ObjectData(c *gin.Context, object interface{}) error {
	...
	if err != nil {
		return fmt.Errorf(i18n.Translate("relay.error_marshalling_object_6d2f"), err)
	}
...
func WssObject(c *gin.Context, ws *websocket.Conn, object interface{}) error {
	jsonData, err := common.Marshal(object)
	if err != nil {
		return fmt.Errorf(i18n.Translate("relay.error_marshalling_object_0d5c"), err)
	}
	if ws == nil {
		logger.LogError(c, i18n.Translate("relay.websocket_connection_is_nil"))
		return errors.New(i18n.Translate("relay.websocket_connection_is_nil_40ad"))
	}
