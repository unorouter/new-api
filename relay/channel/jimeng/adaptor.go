...
func (a *Adaptor) ConvertOpenAIRequest(c *gin.Context, info *relaycommon.RelayInfo, request *dto.GeneralOpenAIRequest) (any, error) {
	if request == nil {
		return nil, errors.New(i18n.Translate("relay.request_is_nil_171d"))
	}
	return request, nil
}
...
func (a *Adaptor) DoRequest(c *gin.Context, info *relaycommon.RelayInfo, requestBody io.Reader) (any, error) {
	...
	if err != nil {
		return nil, fmt.Errorf(i18n.Translate("relay.get_request_url_failed_c0b2"), err)
	}
	req, err := http.NewRequest(c.Request.Method, fullRequestURL, requestBody)
	if err != nil {
		return nil, fmt.Errorf(i18n.Translate("relay.new_request_failed_2080"), err)
	}
	err = Sign(c, req, info.ApiKey)
	if err != nil {
		return nil, fmt.Errorf(i18n.Translate("relay.setup_request_header_failed_2179"), err)
	}
	resp, err := channel.DoRequest(c, req, info)
	if err != nil {
		return nil, fmt.Errorf(i18n.Translate("relay.do_request_failed_30b1"), err)
	}
	return resp, nil
}
