...
func HandleWebSocket(c *gin.Context) {
	...
	// There is no inbound rate limit on this endpoint otherwise. A bucket
	// rather than a floor, because room traffic legitimately arrives in bursts.
	var roomRate roomLimiter
	for {
