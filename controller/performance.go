...
func ClearDiskCache(c fuego.ContextNoBody) (dto.MessageResponse, error) {
	...
	return dto.Msg(common.TranslateMessage(dto.GinCtx(c), "performance.disk_cache_cleared"))
}
...
func ResetPerformanceStats(c fuego.ContextNoBody) (dto.MessageResponse, error) {
	...
	return dto.Msg(common.TranslateMessage(dto.GinCtx(c), "performance.stats_reset"))
}
...
func ForceGC(c fuego.ContextNoBody) (dto.MessageResponse, error) {
	...
	return dto.Msg(common.TranslateMessage(dto.GinCtx(c), "performance.gc_executed"))
}
