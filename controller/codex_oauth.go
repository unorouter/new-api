...
func completeCodexOAuthWithChannelID(ginCtx *gin.Context, reqCtx context.Context, input string, channelID int) (*dto.Response[dto.CodexOAuthCompleteData], error) {
	...
	if err != nil {
		...
		return dto.Fail[dto.CodexOAuthCompleteData]("Failed to parse authorization information, please check input format")
	}
	...
	if err != nil {
		...
		return dto.Fail[dto.CodexOAuthCompleteData]("Authorization code exchange failed, please try again")
	}
