...
func getIoAPIKey() (string, error) {
	...
	if !enabled || strings.TrimSpace(apiKey) == "" {
		return "", errors.New(i18n.Translate("ctrl.io_net_model_deployment_is_not_enabled_or"))
	}
	return apiKey, nil
}
...
func mapIoNetDeployment(d ionet.Deployment) dto.DeploymentItem {
	...
	if timeRemainingHours > 0 {
		...
		timeRemaining = fmt.Sprintf(i18n.Translate("ctrl.minutes"), timeRemainingMins)
	} else {
		timeRemaining = i18n.Translate("ctrl.completed")
	}
...
func TestIoNetConnection(c fuego.ContextWithBody[dto.TestIoNetConnectionRequest]) (*dto.Response[dto.TestConnectionResponse], error) {
	req, err := c.Body()
	if err != nil {
		return dto.Fail[dto.TestConnectionResponse](i18n.Translate("ctrl.invalid_request_payload"))
	}
	...
	if apiKey == "" {
		...
		common.OptionMapRWMutex.RUnlock()
		if storedKey == "" {
			return dto.Fail[dto.TestConnectionResponse](i18n.Translate("ctrl.api_key_is_required"))
		}
		apiKey = storedKey
	}
...
func GetDeployment(c fuego.ContextNoBody) (*dto.Response[dto.DeploymentDetailResponse], error) {
	...
	if deploymentID == "" {
		return dto.Fail[dto.DeploymentDetailResponse](i18n.Translate("ctrl.deployment_id_is_required"))
	}
...
func UpdateDeploymentName(c fuego.ContextWithBody[dto.UpdateDeploymentNameRequest]) (*dto.Response[dto.UpdateNameResponse], error) {
	...
	deploymentID := strings.TrimSpace(c.PathParam("id"))
	if deploymentID == "" {
		return dto.Fail[dto.UpdateNameResponse](i18n.Translate("ctrl.deployment_id_is_required_ec91"))
	}
	...
	if updateReq.Name == "" {
		return dto.Fail[dto.UpdateNameResponse](i18n.Translate("ctrl.deployment_name_cannot_be_empty"))
	}

	available, err := client.CheckClusterNameAvailability(updateReq.Name)
	if err != nil {
		return dto.Fail[dto.UpdateNameResponse](fmt.Sprintf(i18n.Translate("ctrl.failed_to_check_name_availability"), err.Error()))
	}

	if !available {
		return dto.Fail[dto.UpdateNameResponse](i18n.Translate("ctrl.deployment_name_is_not_available_please_choose_a"))
	}
...
func UpdateDeployment(c fuego.ContextWithBody[ionet.UpdateDeploymentRequest]) (*dto.Response[dto.DeploymentStatusResponse], error) {
	...
	deploymentID := strings.TrimSpace(c.PathParam("id"))
	if deploymentID == "" {
		return dto.Fail[dto.DeploymentStatusResponse](i18n.Translate("ctrl.deployment_id_is_required_fc4d"))
	}
...
func ExtendDeployment(c fuego.ContextWithBody[ionet.ExtendDurationRequest]) (*dto.Response[dto.DeploymentItem], error) {
	...
	deploymentID := strings.TrimSpace(c.PathParam("id"))
	if deploymentID == "" {
		return dto.Fail[dto.DeploymentItem](i18n.Translate("ctrl.deployment_id_is_required_1752"))
	}
...
func DeleteDeployment(c fuego.ContextNoBody) (*dto.Response[dto.DeleteDeploymentResponse], error) {
	...
	deploymentID := strings.TrimSpace(c.PathParam("id"))
	if deploymentID == "" {
		return dto.Fail[dto.DeleteDeploymentResponse](i18n.Translate("ctrl.deployment_id_is_required_1f64"))
	}
...
func GetAvailableReplicas(c fuego.ContextWithParams[dto.GetAvailableReplicasParams]) (*dto.Response[*ionet.AvailableReplicasResponse], error) {
	...
	if c.QueryParam("hardware_id") == "" {
		return dto.Fail[*ionet.AvailableReplicasResponse](i18n.Translate("ctrl.hardware_id_parameter_is_required"))
	}

	hardwareID := p.HardwareID
	if hardwareID <= 0 {
		return dto.Fail[*ionet.AvailableReplicasResponse](i18n.Translate("ctrl.invalid_hardware_id_parameter"))
	}
...
func CheckClusterNameAvailability(c fuego.ContextWithParams[dto.CheckClusterNameAvailabilityParams]) (*dto.Response[dto.ClusterNameAvailabilityResponse], error) {
	...
	if clusterName == "" {
		return dto.Fail[dto.ClusterNameAvailabilityResponse](i18n.Translate("ctrl.name_parameter_is_required"))
	}
...
func GetDeploymentLogs(c fuego.ContextWithParams[dto.GetDeploymentLogsParams]) (*dto.Response[string], error) {
	...
	deploymentID := strings.TrimSpace(c.PathParam("id"))
	if deploymentID == "" {
		return dto.Fail[string](i18n.Translate("ctrl.deployment_id_is_required_8c49"))
	}

	containerID := p.ContainerID
	if containerID == "" {
		return dto.Fail[string](i18n.Translate("ctrl.container_id_parameter_is_required"))
	}
...
func ListDeploymentContainers(c fuego.ContextNoBody) (*dto.Response[dto.ContainerListResponse], error) {
	...
	deploymentID := strings.TrimSpace(c.PathParam("id"))
	if deploymentID == "" {
		return dto.Fail[dto.ContainerListResponse](i18n.Translate("ctrl.deployment_id_is_required_4337"))
	}
...
func GetContainerDetails(c fuego.ContextNoBody) (*dto.Response[dto.ContainerDetailResponse], error) {
	...
	deploymentID := strings.TrimSpace(c.PathParam("id"))
	if deploymentID == "" {
		return dto.Fail[dto.ContainerDetailResponse](i18n.Translate("ctrl.deployment_id_is_required_21cf"))
	}

	containerID := strings.TrimSpace(c.PathParam("container_id"))
	if containerID == "" {
		return dto.Fail[dto.ContainerDetailResponse](i18n.Translate("ctrl.container_id_is_required"))
	}
	...
	if details == nil {
		return dto.Fail[dto.ContainerDetailResponse](i18n.Translate("ctrl.container_details_not_found"))
	}
