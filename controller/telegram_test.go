...
func TestTelegramOAuthConfigurationAndLegacyEndpoints(t *testing.T) {
	...
	status := securityEnrollmentRequest("GET", "/api/status", "", "", fixture.identity, fuegoNoBody(GetStatus))
	...
	options := securityEnrollmentRequest("GET", "/api/option/", "", "", fixture.identity, fuegoNoBody(GetOptions))
