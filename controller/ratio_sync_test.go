...
func TestRatioConfigExportsEffectiveExpressions(t *testing.T) {
	...
	response, err := GetRatioConfig(fuego.NewMockContext[any, any](nil, nil))
...
func TestPricingSyncCompleteSourcesAndArrayFormats(t *testing.T) {
	...
	recorder := modelManagementRequest(t, fuegoWithBody(FetchUpstreamRatios), http.MethodPost, "/api/channel/fetch_upstream_ratios", body, &response)
