...
func ParseParams[P any](c FuegoCtx) (P, error) {
	...
	if paramsType.Kind() != reflect.Struct {
		return *p, fmt.Errorf(common.Translate("dto.params_must_be_a_struct_got"), *p)
	}
...
func setParamValue(value reflect.Value, paramValue string, kind reflect.Kind) error {
	...
	case reflect.Int, reflect.Int8, reflect.Int16, reflect.Int32, reflect.Int64:
		...
		if err != nil {
			return fmt.Errorf(common.Translate("dto.cannot_convert_o"), paramValue, kind, err)
		}
		value.SetInt(intValue)
	case reflect.Uint, reflect.Uint8, reflect.Uint16, reflect.Uint32, reflect.Uint64:
		uintValue, err := strconv.ParseUint(paramValue, 10, bitSize(kind))
		if err != nil {
			return fmt.Errorf(common.Translate("dto.cannot_convert_o_56c5"), paramValue, kind, err)
		}
		value.SetUint(uintValue)
	case reflect.Float32, reflect.Float64:
		floatValue, err := strconv.ParseFloat(paramValue, bitSize(kind))
		if err != nil {
			return fmt.Errorf(common.Translate("dto.cannot_convert_o_4fa3"), paramValue, kind, err)
		}
		value.SetFloat(floatValue)
	case reflect.Bool:
		boolValue, err := strconv.ParseBool(paramValue)
		if err != nil {
			return fmt.Errorf(common.Translate("dto.cannot_convert_o_bool"), paramValue, err)
		}
		value.SetBool(boolValue)
	default:
		return fmt.Errorf(common.Translate("dto.unsupported_type"), kind)
	}
	return nil
}
