...
export function createRoutingPolicySchema(t: TFunction) {
  return z.object({
    ...
    MaxTotalRelayAttempts: z.number().int().min(1).max(50),
...
export function routingPolicyFormValues(
  ...
  return {
    ...
    MaxTotalRelayAttempts: Number(options.MaxTotalRelayAttempts),
...
export function routingPolicyOptions(
  ...
  return {
    ...
    MaxTotalRelayAttempts: String(values.MaxTotalRelayAttempts),
